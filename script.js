...
const translations = {
    ...
    vi: {
        ...
        objectiveP2: "Trong vòng 2-3 năm tới, mục tiêu của tôi là đảm nhận một vị trí chuyên nghiệp như <strong>Data Analyst</strong>, <strong>BI Analyst</strong> hoặc <strong>Research Analyst</strong>, nơi tôi có thể áp dụng các phương pháp định lượng để giải quyết các bài toán kinh doanh và kinh tế phức tạp. Về lâu dài, tôi mong muốn phát triển thành <strong>Senior Data Analyst</strong> hoặc <strong>Quantitative Researcher</strong>, góp phần thúc đẩy sự tăng trưởng chiến lược và thiết kế chính sách thông qua các quyết định dựa trên dữ liệu.",
        ...
        skillRSDesc: "Xây dựng thiết kế nghiên cứu, tổng quan tài liệu và viết báo cáo khoa học.",
