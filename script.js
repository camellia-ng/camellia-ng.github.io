...
const translations = {
    en: {
        ...
        certGoogleAiName: "Google AI Professional Certificate",
        certGoogleAiDesc: "Professional certificate from Google focused on AI fluency. Covers AI fundamentals, prompt engineering, and applying AI to brainstorming, research, communication, content creation, data analysis, and vibe coding custom AI solutions.",
        certGoogleName: "Google Data Analysis with Python Specialization",
        certGoogleDesc: "Specialization from Google focused on foundational Python programming, utilizing data analysis and visualization libraries like Pandas, NumPy, and Matplotlib to clean, process, and analyze real-world datasets, conduct exploratory data analysis (EDA), and apply descriptive statistics to extract business insights.",
        ...
        skillRSTitle: "Research Methodology",
        skillRSDesc: "Formulating research designs, conducting literature reviews, and writing academic papers.",
    ...
    vi: {
        ...
        heroDesc: "Sinh viên chuyên ngành Kinh tế Quốc tế tại Đại học Ngoại thương với định hướng phát triển chuyên sâu về nghiên cứu định lượng. Sở hữu thế mạnh trong việc thu thập dữ liệu, xây dựng mô hình kinh tế lượng và dự báo chuỗi thời gian. Vận dụng thành thạo các công cụ như Excel, Stata, EViews, SQL cùng Python hướng tới mục tiêu xử lý những bài toán phân tích phức tạp, đề xuất giải pháp mang tính ứng dụng cao.",
        btnViewProjects: "Xem dự án",
        btnViewResume: "Xem CV",
        objectiveTitle: "Mục tiêu nghề nghiệp",
        objectiveP1: "Được đào tạo nền tảng kiến thức vững chắc về Kinh tế quốc tế ở <strong>Trường Đại học Ngoại Thương</strong>, kết hợp cùng bộ kỹ năng chuyên môn sâu trong thu thập dữ liệu, mô hình hóa kinh tế lượng, dự báo chuỗi thời gian và phân tích thông qua <strong>Stata, EViews, Excel (MOS), SQL và Python</strong>.",
        objectiveP2: "<strong>Mục tiêu ngắn hạn:</strong> Đảm nhận vai trò <strong>Data Analyst</strong>, <strong>Business Intelligence Analyst</strong> hoặc <strong>Research Analyst</strong>, hướng tới việc ứng dụng linh hoạt các phương pháp định lượng nhằm tháo gỡ những bài toán phức tạp trong thực tiễn kinh doanh và kinh tế.<br><strong>Mục tiêu dài hạn:</strong> Phát triển lên vị trí <strong>Senior Data Analyst</strong> hoặc <strong>Quantitative Researcher</strong>, tham gia sâu vào hoạch định chiến lược và đưa ra quyết định dựa trên dữ liệu.",
        eduSubtitle: "Nền tảng",
        eduTitle: "Học vấn & Chứng chỉ",
        eduHeader: "Học vấn",
        eduFtuName: "Trường Đại học Ngoại Thương",
        eduFtuYears: "2023 - nay",
        eduFtuMajor: "Sinh viên ngành Kinh tế quốc tế",
        eduFtuGpa: "GPA: <strong>3.63 / 4.00</strong>",
        eduFtuDesc: "Học tập trong môi trường năng động tại Đại học Ngoại thương giúp rèn luyện tư duy logic nhạy bén, kỹ năng giải quyết bài toán kinh doanh thực tế cùng năng lực thuyết trình và làm việc nhóm hiệu quả.",
        ...
        certGoogleAiName: "Google AI Professional Certificate",
        certGoogleAiDesc: "Chương trình chuyên sâu của Google đào tạo sử dụng AI thành thạo trong công việc, bao gồm kiến thức cơ bản về AI, kỹ thuật viết prompt, ứng dụng AI để lên ý tưởng, nghiên cứu, giao tiếp, phân tích dữ liệu và phát triển giải pháp AI.",
        certGoogleName: "Google Data Analysis with Python Specialization",
        certGoogleDesc: "Chương trình đào tạo chuyên sâu của Google tập trung vào lập trình Python cơ bản, sử dụng các thư viện phân tích dữ liệu và trực quan hóa như Pandas, NumPy, Matplotlib để làm sạch, xử lý và phân tích tập dữ liệu thực tế, thực hiện phân tích khám phá dữ liệu (EDA) và ứng dụng thống kê mô tả để rút ra các thông tin chi tiết hỗ trợ ra quyết định kinh doanh.",
        certExcelName: "Microsoft Office Specialist: Excel (Office 2016)",
        ...
        skillATDesc: "Có khả năng chuyển hóa các bài toán kinh doanh phức tạp thành các câu hỏi kỹ thuật cụ thể và đưa ra giải pháp xử lý bằng dữ liệu.",
        skillRSTitle: "Phương pháp nghiên cứu",
        skillRSDesc: "Am hiểu quy trình nghiên cứu khoa học, từ xây dựng đề cương, tổng quan tài liệu học thuật đến viết báo cáo hoàn chỉnh.",
        skillDSTitle: "Truyền tải câu chuyện dữ liệu",
        skillDSDesc: "Có khả năng giải thích các con số kỹ thuật phức tạp thành các phân tích kinh doanh trực quan, dễ hiểu cho các bên liên quan.",
        skillTWTitle: "Làm việc nhóm & Hợp tác",
        skillTWDesc: "Có kỹ năng giao tiếp tốt và điều phối công việc nhịp nhàng, tạo sự gắn kết hiệu quả khi làm việc nhóm.",
        skillPSTitle: "Ứng dụng công cụ AI",
        skillPSDesc: "Thành thạo ứng dụng Generative AI và kĩ thuật viết prompt để tối ưu hóa quy trình nghiên cứu và xử lý dữ liệu.",
