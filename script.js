...
const translations = {
    en: {
        ...
        certGoogleDesc: "Advanced specialization from Google focused on Python for data science, covering data structures, data scraping, SQL database integration, and exploratory data analysis using Pandas, NumPy, and Matplotlib.",
    ...
    vi: {
        ...
        certGoogleName: "Google Data Analysis with Python Specialization",
        certGoogleDesc: "Chuyên ngành nâng cao từ Google tập trung vào Python cho khoa học dữ liệu, bao gồm cấu trúc dữ liệu, thu thập dữ liệu, tích hợp cơ sở dữ liệu SQL và phân tích khám phá dữ liệu (EDA) sử dụng Pandas, NumPy và Matplotlib.",
        certExcelName: "Microsoft Office Specialist: Excel (Office 2016)",
