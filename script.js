...
const translations = {
    ...
    vi: {
        ...
        certGoogleName: "Google Data Analysis with Python Specialization",
        certGoogleDesc: "Chương trình đào tạo chuyên sâu của Google về Python cho khoa học dữ liệu, trang bị kiến thức từ cấu trúc dữ liệu, cào dữ liệu (data scraping) đến phân tích khám phá dữ liệu (EDA) bằng Pandas, NumPy và Matplotlib.",
        certExcelName: "Microsoft Office Specialist: Excel (Office 2016)",
